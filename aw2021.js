...
//this checks which image is curently being displayed
    if (document.getElementById("ProductImg").getAttribute("src") == "layred%20corset%201.png") {
        //this changes the image to image 2
        document.getElementById("ProductImg").src = "layred%20corset%202.png";
    }
    else {
        //this changes the image to image 1
        document.getElementById("ProductImg").src = "layred%20corset%201.png";
    }
}